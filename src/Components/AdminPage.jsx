                    ...
                    <g id="c">
                      <g id="e">
                        <g id="b">
                          ...
                          />
                          {React.createElement('use', { 'xlink:href': "#a", y: "420" })}
                          {React.createElement('use', { 'xlink:href': "#a", y: "840" })}
                          {React.createElement('use', { 'xlink:href': "#a", y: "1260" })}
                        </g>
                        {React.createElement('use', { 'xlink:href': "#a", y: "1680" })}
                      </g>
                      {React.createElement('use', { 'xlink:href': '#b', x: '247', y: '210' })}
                    </g>
                    {React.createElement('use', { 'xlink:href': '#c', x: '494' })}
                  </g>
                  {React.createElement('use', { 'xlink:href': "#c", x: "988" })}
                  {React.createElement('use', { 'xlink:href': "#c", x: "1976" })}
                  {React.createElement('use', { 'xlink:href': "#e", x: "2470" })}
                </g>
              </svg>
            </button>
            {/* <!-- Dropdown --> */}
